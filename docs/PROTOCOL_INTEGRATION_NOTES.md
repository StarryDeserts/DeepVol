...
Status: Updated for DeepVol-18-fix-2: create_series is permissionless but not mintability proof. Fresh BTC MOVE VolSeries creation and buy readiness now require mintable range validation. See DEEPVOL_ACTIVE_MOVE_SERIES.md and DEEPVOL_MINTABLE_MOVE_RANGE.md.
