...
Status: DeepVol-25 adds DEEPVOL_PREDICT_MANAGER_UX.md and DEEPVOL_PORTFOLIO_PRIMITIVE_POSITIONS.md for wallet-scoped manager session UX and primitive Portfolio readback. DeepVol-24-fix adds DEEPVOL_RANGE_MINTABILITY_DIAGNOSTICS.md for RANGE candidate failure diagnostics. DeepVol-23 records UP/DOWN primitive Testnet validation success, adds RANGE execution path (pending validation), and adds DEEPVOL_PRIMITIVE_UP_DOWN_VALIDATION.md and DEEPVOL_RANGE_PRIMITIVE_TRADING.md. DeepVol-21 adds mintable strike candidate search for UP/DOWN primitives and DEEPVOL_PRIMITIVE_DIRECT_TRADING.md. Updated for DeepVol-20 fresh BTC MOVE buy validation, DeepVol-18-fix-2 mintable BTC MOVE range validation, active BTC primitive market discovery, and wallet-gated UP/DOWN primitive execution.
