...
| Portfolio/redeem/claim | Product spec, protocol analysis, official contract info, entrypoint bindings plan, portfolio readback validation, range redeem validation, architecture map, protocol integration notes |
